<template>
  <div id="app">
    <b-navbar toggleable="md" variant="dark" type="dark">
      ...
      <img src="./assets/smallLogo.png" class="img-circle" style="padding: 5px">
      <b-navbar-brand to="/">Library System</b-navbar-brand>
      <b-collapse is-nav id="nav_collapse">
        <b-navbar-nav>
          ...
          <b-nav-item to="/addBook"><i class="fa fa-money" style="padding: 5px"> Add book</i></b-nav-item>
...
<style>
  #app {
    ...
    color: #2c3e50;
    padding-top: 20px;
    background: url("./assets/Library.jpg") repeat center top;
  }
  .VueTables__sortable {
    cursor: pointer;
  }
